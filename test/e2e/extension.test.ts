...
describe('Keypress Notifications E2E Tests', () => {
  ...
  let api: KeypressNotificationsApi | undefined;
  let notificationSubscription: vscode.Disposable | undefined;

  before(async () => {
    const extension = vscode.extensions.getExtension<KeypressNotificationsApi>(
    ...
    notificationSubscription = api.onDidShowNotification((message) => {
