...
export class ConfigurationService implements IConfigurationService {
  ...
  private constructor(logger: ILogger) {
    this.logger = logger;
    this.migrator = ConfigMigrator.getInstance();
  }
  ...
  /**
	 ...
	 *
	 * @deprecated Use DI injection instead: `container.get<IConfigurationService>(TYPES.ConfigurationService)`
	 *
	 * @example
	 * ```typescript
  ...
  public static getInstance(): ConfigurationService {
    this.instance ??= new ConfigurationService(Logger.getInstance());
  ...
  /**
	 ...
	 *
	 * @description
	 * Sets up configuration with migration support.
	 * Reads initial configuration and applies log level settings.
	 *
	 * @example
	 * ```typescript
